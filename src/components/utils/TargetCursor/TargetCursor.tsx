...
const TargetCursor: React.FC<TargetCursorProps> = ({
  targetSelector = ".cursor-target, .register-button",
  spinDuration = 2,
  ...
  return (
    <div
      ref={cursorRef}
      className="hidden lg:inline-block fixed top-0 left-0 w-0 h-0 pointer-events-none z-[9999] mix-blend-difference transform -translate-x-1/2 -translate-y-1/2"
