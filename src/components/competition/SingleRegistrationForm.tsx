...
export default function SingleRegistrationForm({
  ...
  return (
    <form
      ...
      className="single-regis-form flex backdrop-blur-lg flex-col items-center justify-center gap-1.5 sm:gap-2 md:gap-2 lg:gap-6 rounded-xl shadow-lg bg-[url('/register/MultipleformBG.svg')] sm:bg-[url('/register/MultipleformBG.svg')] bg-contain bg-center bg-no-repeat"
    >
      <h2 className="font-RopoSans-Regular single-regis-title text-lg md:text-3xl lg:text-3xl font-bold text-center text-white">
        {competitionTitle}
      </h2>
      ...
      <div className="single-regis-input-container gap-2 sm:gap-4 flex flex-col justify-center items-center w-[80%] sm:w-[85%]">
        ...
        <div className="single-regis-name-nisn-container flex w-full justify-center gap-1 sm:gap-4">
          <div className="flex flex-col w-full">
            <label
              className="regis-label text-left w-full font-ropasans-regular text-2xl"
          ...
          <div className="flex flex-col w-full">
            ...
            >
              Twibbon Link <Link className="regis-label underline" target="_blank" href="https://drive.google.com/drive/u/1/folders/18KHSP5Na7wal4sr-HEPvAtCPSvQ3LG8m">{`(Link template)`}</Link>
            </label>
            <input
              id="link_twiboon1"
              type="url"
              ...
              className="cursor-target px-[2.5%] w-full single-all-input bg-[#18182a]/80 border-2 border-[#FCF551] rounded-none 
                  ...
                  text-[#75E8F0] placeholder-[#75E8F0]     [text-shadow:_0_0_20px_rgba(0,255,255,1)] 
                                placeholder:[text-shadow:_0_0_8px_rgba(0,255,255,0.8)] focus:outline-none focus:border-yellow-300 transition-colors"
              placeholder="Enter Twibbon link"
              required
            />
          </div>
        </div>
          ...
          >
            <div className="flex flex-col w-full">
              ...
              <input
                ...
                type="text"
                name={`fullname${i}`}
                className="cursor-target px-[2.5%] single-all-input bg-[#18182a]/80 border-2 border-[#FCF551] rounded-none 
