...
export default async function RegistrationDetail({
  ...
  return (
    <div className="min-h-screen bg-[#090A1E] text-white pt-[10vh] overflow-hidden">
      {/* Header */}
          ...
          <div className="bg-[#18182a]/80 border-2 border-[#FCF551] rounded-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-white text-lg">
                  {registration.data?.competition.name}
                </p>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <p className="text-white text-lg">
                  {registration.data?.contact_person_number}
                </p>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <p className="text-white text-lg">
                  {registration.data?.createdAt
                    ? new Date(registration.data.createdAt).toLocaleString()
                    : "N/A"}
                </p>
              </div>
            </div>
